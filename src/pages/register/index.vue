...
const rules = reactive({
  email: [{ required: true, message: t('register.pleaseEnterEmail') }],
  code: [{ required: true, message: t('register.pleaseEnterCode') }],
  nickname: [{ required: true, message: t('register.pleaseEnterNickname') }],
  password: [{ required: true, message: t('register.pleaseEnterPassword') }],
  confirmPassword: [
